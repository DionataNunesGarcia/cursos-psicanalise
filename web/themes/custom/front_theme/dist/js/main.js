(() => {
  ...
  ScrollTrigger3.refresh = function(safe) {
    return safe ? _onResize(true) : (_coreInitted3 || ScrollTrigger3.register()) && _refreshAll(true);
  };
  ...
  (function() {
    ...
    function initObserverFallback2() {
    ...
    function init4() {
      autoApplyAttributes2();
      prepareElements2();
      initBatchAnimations2();
      initObserverFallback2();
      hoverEffects2();
      parallax2();
  ...
  (function($, Drupal2, once2) {
    Drupal2.behaviors.searchModal = {
      attach: function(context3, settings) {
        const elements = once2("initSearchIcon", ".btn-search", context3);
        ...
        `;
          ...
          $btn.on("click", function(e) {
            ...
            const ajaxUrl = Drupal2.url("search/node");
            const dialogOptions = {
